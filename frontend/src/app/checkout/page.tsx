...
export default function CheckoutPage() {
    ...
    useEffect(() => {
        ...
        setListingId(Number(params.get("listingId")));
        ...
        return (
            <main className="min-h-screen bg-gray-50 px-6 py-16">
                <div className="mx-auto max-w-lg rounded-2xl border bg-white p-8 text-center shadow-sm">
                    ...
                    <Link
                        href="/trips"
                        className="mt-7 block rounded-xl bg-rose-500 py-3 font-semibold text-white hover:bg-rose-600"
                    >
                        View My Trips
                    </Link>
                </div>
                ...
                <div className="mt-8 grid gap-8 md:grid-cols-2">
                    ...
                    <div className="h-fit rounded-2xl border bg-white p-6">
                        ...
                        <button
                            ...
                            disabled={paying}
                            className="mt-7 w-full rounded-xl bg-rose-500 py-3 font-semibold text-white hover:bg-rose-600 disabled:bg-gray-300"
                        >
                            {paying
                                ? "Processing payment..."
